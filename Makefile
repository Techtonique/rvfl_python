...
coverage: ## check code coverage quickly with the default Python	
	coverage report --omit="venv/*,rvfl/tests/*" --show-missing

docs: install ## generate docs		
	uv pip install black pdoc 
	black rvfl/* --line-length=80	
	find rvfl/ -name "*.py" -exec autopep8 --max-line-length=80 --in-place {} +
	pdoc -t docs rvfl/* --output-dir rvfl-docs
	find . -name '__pycache__' -exec rm -fr {} +
	cp -rf rvfl-docs/* ../../Pro_Website/Techtonique.github.io/rvfl_python
...
build-site: docs ## export mkdocs website to a folder		
	cp -rf rvfl-docs/* ../../Pro_Website/Techtonique.github.io/rvfl
	find . -name '__pycache__' -exec rm -fr {} +
